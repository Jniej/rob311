...
class BBController(Controller):
    ...
    def on_R3_up(self, value):
        ...
        self.dphi_x_sp = -1.0 * (value/JOYSTICK_SCALE)# * self.MAX_VELOCITY 
    ...
    def on_L3_up(self, value):
        #TODO: increase velocity
        self.dphi_y_sp = -1.0 * (value/JOYSTICK_SCALE) * self.MAX_VELOCITY 
    ...
    def on_R2_press(self, value):
        ...
        self.Tz = 1.5 * (1.0 + (value/JOYSTICK_SCALE))/1.0
