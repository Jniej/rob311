...
DPHI_DEADBAND = 0.5  # Deadband for Ball velocity
...
ROLL_THETA_KP = 0.0  # Roll angle proportional gain
ROLL_THETA_KI = 0.0  # Roll angle integral gain
ROLL_THETA_KD = 0.0  # Roll angle derivative gain

PITCH_THETA_KP = 0.0  # Pitch angle proportional gain
PITCH_THETA_KI = 0.0  # Pitch angle integral gain
...
DPHI_KP = 0.11  # Lean angle proportional gain
DPHI_KI = 0.0008  # Lean angle integral gain
...
# Deadband for Ball Velocity
DPHI_DEADBAND = 0.30  # Deadband for Ball velocity
...
ROLL_THETA_KP = 6.7  # Roll angle proportional gain
ROLL_THETA_KI = 10  # Roll angle integral gain
ROLL_THETA_KD = 0.001  # Roll angle derivative gain

PITCH_THETA_KP = 6.7  # Pitch angle proportional gain
PITCH_THETA_KI = 10  # Pitch angle integral gain
PITCH_THETA_KD = 0.001  # Pitch angle derivative gain

# Steering Controller Gains (Can be either a velocity or a position controller)
DPHI_KP = 0.15 #0.15  # Lean angle proportional gain
DPHI_KI = 0.008  # Lean angle integral gain
DPHI_KD = 0.00  # Lean angle derivative gain
